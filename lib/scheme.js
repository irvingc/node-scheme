...
function isQuote(expr) {
  return isSymbol(expr) && expr.val == Scheme.Special.Quote;
}
...
// Build alist
var isNullDef = makeFunctionDefinition('nullp', function(x) { return builtins.isNull(x.car)});
...
symbolList.append(new Scheme.Cons(cdrDef));
